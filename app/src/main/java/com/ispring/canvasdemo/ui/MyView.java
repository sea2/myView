...
public class MyView extends View {
    ...
    private void drawAxis(Canvas canvas) {
        ...
        for (int i = 0; i < 10; i++) {
            if (i % 2 == 0) {
                ...
                paint.setColor(0xff0000ff);//绿色
            }
            int intWidth = i * 50;
            canvas.drawLine(intWidth, intWidth, canvasWidth-intWidth, intWidth, paint);//绘制x轴
            canvas.drawLine(canvasWidth-intWidth, intWidth, canvasWidth-intWidth, canvasWidth-intWidth, paint);
            canvas.drawLine(intWidth, intWidth, intWidth, canvasWidth-intWidth, paint);//绘制y轴
            canvas.drawLine(intWidth, canvasWidth-intWidth, canvasWidth-intWidth, canvasWidth-intWidth, paint);
    ...
    private void drawLine(Canvas canvas) {
        ...
        float[] pts = {50, 0, halfWidth, halfDeltaY, halfWidth, halfDeltaY, canvasWidth - 50, 0};
